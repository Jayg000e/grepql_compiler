...
@tmp.3 = private unnamed_addr constant [8 x i8] c"nononon\00", align 1
...
entry:
  ...
  %append3 = call i32 @append({ i8**, i32, i32 }* %a2, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @tmp.3, i32 0, i32 0))
